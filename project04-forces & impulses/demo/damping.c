 ...
 * @param initial_position the position the center of the ball will be initialized to
 ...
 * height, as well as NUM_BODIES number of invisible balls at the equilibrium height
 * @param world the scene in which the balls will be added
