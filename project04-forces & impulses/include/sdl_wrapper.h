 ...
 * @param curr_body the body to be affected by the key pressed
 */
 ...
 * @param curr_body the object to be affected by each key press
 */
void sdl_on_key(key_handler_t handler, body_t *curr_body);
