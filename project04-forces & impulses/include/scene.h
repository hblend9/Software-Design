...
/**
 * Returns a pointer to the list of bodies stored in the scene
 *
 * @param scene a pointer to a scene returned from scene_init()
 * @return see above
 */
...
/**
 * A setter function to change the dimensions of the world
 */
void scene_set_dims(scene_t *scene, vector_t new_min, vector_t new_max);

/**
 * A getter function to extract the minimum dimensions of the world
 */
vector_t scene_get_min(scene_t *scene);

/**
 * A getter function to extract the maximum dimensions of the world
 */
